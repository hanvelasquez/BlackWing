Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/aa36cf2284fcc3744aa1fb58d415c77c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = max(UNITY_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, CreateIndirectLight(poiMesh, poiCam, poiLight)).xyz, (0.0 /*_LightingMinLightBrightness*/));
				#endif
				#endif
				#ifdef POI_PASS_ADD
